...
let () =
  ...
  neg_test_search_utf8
    (ignorecase <+> ignorecase_is_ascii)
    none "\xc3\xa4" "\xc3\x84";
  test_search_utf8 ignorecase none "\xc3\xa4" "\xc3\x84" [ (0, 2) ];
  test_search_ascii (ignorecase <+> ignorecase_is_ascii) none "a" "A" [ (0, 1) ];

  test_match_ascii none none "\\Aa" 0 "abc" [ (0, 1) ];
  neg_test_match_ascii none not_begin_string "\\Aa" 0 "abc";

  test_search_ascii none none "b\\z" "ab" [ (1, 2) ];
  neg_test_search_ascii none not_end_string "b\\z" "ab"
