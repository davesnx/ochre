(** TextMate / VS Code theme loading and representation.
    ...
    Themes define the color scheme used to style syntax-highlighted code.
    Ochre supports the same JSON format as VS Code themes, including
    the [colors] and [tokenColors] fields. *)

(** Hex color string (e.g. ["#569cd6"]). *)
type color = string

(** Font style variants, mirroring {!Token.type-font_style}. *)
