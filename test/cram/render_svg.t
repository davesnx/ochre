Keyword and number coloring in SVG output
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="112" height="40" font-family="ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace" font-size="14px">
...
Comment with italic styling in SVG
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="121" height="40" font-family="ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace" font-size="14px">
   <rect width="100%" height="100%" fill="#1e1e1e"/>
...
String coloring in SVG
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="154" height="40" font-family="ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace" font-size="14px">
   <rect width="100%" height="100%" fill="#1e1e1e"/>
...
Multiple lines of highlighted SVG
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="112" height="59" font-family="ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace" font-size="14px">
   <rect width="100%" height="100%" fill="#1e1e1e"/>
    <text x="10" y="24.0" xml:space="preserve"><tspan font-weight="bold" fill="#ff0000">let</tspan><tspan fill="#d4d4d4"> x = </tspan><tspan fill="#0000ff">42</tspan><tspan fill="#d4d4d4">
  </tspan></text>
...
XML entities are escaped in SVG output
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="180" height="40" font-family="ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace" font-size="14px">
   <rect width="100%" height="100%" fill="#1e1e1e"/>
