...
Comment with italic styling in SVG
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="112" height="38" font-family="ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace" font-size="14px">
   <rect width="100%" height="100%" fill="#1e1e1e"/>
    <text x="10" y="24.0" font-family="ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace" font-size="14px" xml:space="preserve"><tspan font-style="italic" fill="#888888"># a comment</tspan></text>
  </svg>

String coloring in SVG
  $ ./test_render_svg.exe string
  <svg xmlns="http://www.w3.org/2000/svg" width="146" height="38" font-family="ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace" font-size="14px">
   <rect width="100%" height="100%" fill="#1e1e1e"/>
    <text x="10" y="24.0" font-family="ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace" font-size="14px" xml:space="preserve"><tspan font-weight="bold" fill="#ff0000">let</tspan><tspan fill="#d4d4d4"> s = </tspan><tspan fill="#00ff00">&quot;hello&quot;</tspan></text>
  </svg>
...
XML entities are escaped in SVG output
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="171" height="38" font-family="ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace" font-size="14px">
   <rect width="100%" height="100%" fill="#1e1e1e"/>
    <text x="10" y="24.0" font-family="ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace" font-size="14px" xml:space="preserve"><tspan font-style="italic" fill="#888888"># &lt;div&gt;&amp;amp;&lt;/div&gt;</tspan></text>
  </svg>
